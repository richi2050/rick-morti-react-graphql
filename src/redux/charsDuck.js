...
export default function reducer(state = initialData, action) {
    switch (action.type) {
        ...
        case GET_FAVS_SUCCESS: return {
                ...state,
                fetching: false,
                favorites: action.payload
            }
        case GET_FAVS_ERROR: return {
                ...state,
                fetching: false,
        ...
        case GET_CHARACTERS_ERROR: return {
                ...state,
                fetching: false,
                error: action.payload
            }
...
export let getCharactersAction = () => (dispatch, getState) => {
    ...
    return client.query({
        ...
        dispatch({type: GET_CHARACTERS_SUCCESS, payload: data.characters.results})
